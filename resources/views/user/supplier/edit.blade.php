                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="supplier_code"
                                    value="{{ old('supplier_code', $data->supplier_code) }}"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input value="{{ old('contract_signing_date', $data->contract_signing_date) }}"
                                    type="text"
                                    data-provide="datepicker"
                                    class="form-control datepicker {{ $errors->has('contract_signing_date') ? 'is-invalid' : '' }}"
                                    name="contract_signing_date" id="contract_signing_date">
