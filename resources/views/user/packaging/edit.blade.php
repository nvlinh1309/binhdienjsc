<x-layouts.main>
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form id="quickForm" action="{{ route('packaging.update', $data->id) }}" method="POST">
                @csrf
                @method('PATCH')
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('name')??$data->name }}" type="text" name="name" class="form-control {{ $errors->has('name')?"is-invalid":"" }}" id="name"
