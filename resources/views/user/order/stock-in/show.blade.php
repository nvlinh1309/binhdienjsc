    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="callout callout-info">
                ...
                <div><b>Ngày nhập kho:</b> {{ $goodReceiptManagement->receipt_date }}</div>
                ...
                <button class="btn btn-warning" onclick="window.location=''">Chỉnh sửa</button>
            </div>
                            ...
                            @if (count($productPrice->prices) > 0)
                                ...
                                @foreach ($productPrice->prices as $detailPrice)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $productPrice->date_of_manufacture }}
                                        </td>
                                        <td>
                                            {{ $productPrice->expiry_date }}
                                        </td>
                                    </tr>
                                    <?php $num++; ?>
                                @endforeach
