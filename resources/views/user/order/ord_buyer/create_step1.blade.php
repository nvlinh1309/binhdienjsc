<x-layouts.main>
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form id="quickForm" action="{{ route('order-buyer.update.step1', $order->id) }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input value="{{ old('code') ?? $order->code }}" type="text" name="code"
                                ...
                                <select class="form-control select2" name="approved_by" id="approved_by"
                                    ...
                                    @foreach ($managers as $user)
                                        <option value="{{ $user->id }}"
                                            {{ $user->id == $order->approved_by ? 'selected' : '' }}>
                                            {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="form-control select2" name="supplier_id" id="supplier_id"
                                    ...
                                    @foreach ($suppliers as $supplier)
                                        <option value="{{ $supplier->id }}"
                                            {{ $supplier->id == $order->supplier_id ? 'selected' : '' }}>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="estimated_delivery_time">Thời gian dự kiến giao hàng<span
                                        class="text-danger">*</span></label>
                                <input value="{{ old('estimated_delivery_time') ?? $order->estimated_delivery_time }}"
                                    type="text" name="estimated_delivery_time" class="form-control"
                                    id="estimated_delivery_time" placeholder="Nhập thời gian dự kiến giao hàng...">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="storage_id" id="storage_id"
                                    ...
                                    @foreach ($storages as $storage)
                                        <option value="{{ $storage->id }}"
                                            {{ $storage->id == $order->storage_id ? 'selected' : '' }}>
                                            {{ $storage->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="callout callout-info">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('company_name') ?? $order->company_name }}" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('company_address') ?? $order->company_address }}" type="text"
                                        name="company_address" class="form-control" id="company_address"
                                        placeholder="Nhập địa chỉ...">
                                </div>
                                <div class="form-group">
                                    <label for="company_tax">Mã số thuế<span class="text-danger">*</span></label>
                                    <input value="{{ old('company_tax') ?? $order->company_tax }}" type="text"
                ...
                <div class="card-footer">
                    <a href="{{ route('order-buyer.index') }}" class="btn btn-dark">Thoát</a>
